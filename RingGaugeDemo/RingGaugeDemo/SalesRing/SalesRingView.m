...
@property (nonatomic) CALayer *coloredRingLayer;

/// The ring that reveals the colored portion as it turns.
@property (nonatomic) CALayer *maskRingLayer;
...
- (id)initWithViewModel:(SalesRingViewModel *)viewModel {
    self = [super init];
    if (self) {
...
- (void)layoutSubviews {
    ...
    [_coloredRingLayer setNeedsDisplay];
}
...
- (void)buildView {
    ...
    self.backgroundRingView = [[RingBackgroundView alloc] init];
    ...
    coloredRing.ringColor = [_viewModel colorOfRingFill];
